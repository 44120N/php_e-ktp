...
<body>
    <div class="center" style="min-height: 100vh; margin: 2% 3%;">
        <div class="app">
            ...
            <form action="post.php" method="post">
                <table>
                    <tr>
                        ...
                        <td><input type="number" name="nik" id="nik" placeholder="Masukkan NIK" required></td>
                    </tr>
                    <tr>
                        <td><label for="name">Nama</label></td>
                        <td><input type="text" name="name" id="name" placeholder="Masukkan Nama" required></td>
                    </tr>
                    <tr>
                        <td><label for="birthplace">Tempat Lahir</label></td>
                        <td><input type="text" name="birthplace" id="birthplace" placeholder="Masukkan Tempat Lahir" required></td>
                    </tr>
                    <tr>
                    ...
                    <tr>
                        ...
                        <td><textarea name="address" id="address" placeholder="Masukkan address" required></textarea></td>
                    </tr>
                    <tr>
